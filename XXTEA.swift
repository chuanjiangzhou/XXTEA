...
private static func xxteaMX(z : UInt32, y : UInt32, sum : UInt32, p : Int, e :
UInt32, key : [UInt32] ) -> UInt32 {
...
private static func xxteaUintEncrypt(plainValue : [UInt32], k : [UInt32]) ->
[UInt32] {
...
private static func xxteaUintDecrypt(encryptedValue : [UInt32], k : [UInt32]) ->
[UInt32] {
...
private static func right3 (lhs : Int64 ,rhs : Int64)->Int64{
...
out = toUByteArray(data: xxteaUintEncrypt(plainValue: dataIntArray!, k:
keyIntArray!), includeLength: false)
return out;
}
...
out = toUByteArray(data: xxteaUintDecrypt(encryptedValue: dataIntArray!,
k: keyIntArray!), includeLength: true)
return out;
}
